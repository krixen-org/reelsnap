...
export default function TwitterDownloader() {
  ...
  const fetchVideo = async () => {
    ...
    try {
      const res = await fetch(getApiUrl("/twitter"), {
        method: "POST",
  ...
  return (
    <main className="min-h-screen px-4 py-8 sm:py-12 flex justify-center items-center">
      <div className="w-full max-w-4xl mx-auto animate-fadeIn">
        ...
        <header className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-3 text-gradient from-blue-400 to-cyan-500">
        ...
        {/* Input Section */}
        <section className="glass-card rounded-2xl p-6 sm:p-8 mb-6 border-blue-500/30">
          <div className="space-y-4">
            <div className="relative">
              <input
                type="text"
                className="w-full px-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-cyan-700 hover:from-blue-700 hover:to-cyan-800 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-500/30 disabled:shadow-none"
              aria-label="Fetch Twitter video"
            >
              {loading ? (
        ...
        {data && (
          <article className="glass-card rounded-2xl p-6 sm:p-8 animate-fadeIn">
            ...
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold mb-2 text-white break-words">
